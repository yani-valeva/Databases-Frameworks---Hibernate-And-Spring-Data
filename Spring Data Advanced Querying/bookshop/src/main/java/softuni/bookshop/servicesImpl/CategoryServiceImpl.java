...
public class CategoryServiceImpl implements CategoryService<Category, Long> {
    ...
    public List<Category> findByNameIn(String[] names) {
        return this.categoryRepository.findByNameIn(names);
    }

    @Override
    public List<Object[]> findTotalProfitOfBooksByCategory() {
        return this.categoryRepository.findTotalProfitOfBooksByCategory();
    }
}
