...
//        }
    ...
    private void seed() throws IOException {
        ...
        WritableRaster firstRaster = firstPictureReader.getRaster();
        DataBufferByte firstData = (DataBufferByte) firstRaster.getDataBuffer();
        firstUser.setProfilePicture(firstData.getData());
        ...
        WritableRaster secondRaster = secondPictureReader.getRaster();
        DataBufferByte secondData = (DataBufferByte) secondRaster.getDataBuffer();
        secondUser.setProfilePicture(secondData.getData());
        ...
        WritableRaster thirdRaster = thirdPictureReader.getRaster();
        DataBufferByte thirdData = (DataBufferByte) thirdRaster.getDataBuffer();
        thirdUser.setProfilePicture(thirdData.getData());
